...
public class ContentSecification implements Specification<Content> {

    private List<SearchCriteria> list ;

    public ContentSecification() {
    ...
    @Override
    public Predicate toPredicate(Root<Content> root, CriteriaQuery<?> criteriaQuery, CriteriaBuilder builder) {
