INSERT INTO oauth_client_entity (productId, client_id, application_name, client_secret, authorized_grant_types, authorities,
...
INSERT INTO scope_definition_entity (productId, scope, definition)
values (1, 'user_info', '昵称、头像、性别信息');

insert into role_entity(productId, role_name)
values (1, 'ROLE_SUPER'),
       (2, 'ROLE_ADMIN'),
       (3, 'ROLE_USER');

INSERT INTO user_account_entity (productId, username, password, account_open_code, nick_name, remarks)
